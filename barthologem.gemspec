require_relative 'lib/barthologem/version'

Gem::Specification.new do |spec|
  spec.name          = "barthologem"
  spec.version       = Barthologem::VERSION
  spec.authors       = ["Ed Bartholomew"]
  spec.email         = ["edmbartholomew@gmail.com"]
